            ...
            >
              <tr>
                <td align="center" style="padding: 32px 24px 0 24px">
                  <img
                    src="https://res.cloudinary.com/duowocved/image/upload/v1764108063/Logo2_y0vu0e.png"
                    alt="Heaven Logo"
                    style="height: 40px"
                  />
                </td>
              ...
              <tr>
                <td style="padding: 24px 24px 0 24px">
                  <h2 style="margin: 0 0 12px 0; color: #222">
                    Reset Your Password
                  </h2>
                  <p style="margin: 0 0 16px 0; color: #444">
                    Hi ${username},<br />
                    We received a request to reset your Heaven password. If you
                    made this request, click the button below to set a new
                    password:
                  </p>
              ...
              <tr>
                <td
                  align="center"
                  style="padding: 32px 0 16px 0; color: #bbb; font-size: 13px"
                >
                  Heaven &copy;  ${new Date().getFullYear()} &mdash; All Rights Reserved
                </td>
              </tr>
            </table>
          </td>
          ...
          <td align="center" style="padding: 24px 0">
            ...
            >
              ...
              <tr>
                <td style="padding: 24px 24px 0 24px">
                  <h2 style="margin: 0 0 12px 0; color: #222">
                    Welcome to Heaven, ${username}!
                  </h2>
                  <p style="margin: 0 0 16px 0; color: #444">
                    Thank you for signing up. Please confirm your email address
                    to activate your Heaven account and start your journey.
                  </p>
                  <div style="text-align: center; margin: 24px 0">
                    <a
                      href="${link}"
                  ...
                  <p style="margin: 0 0 12px 0; color: #888; font-size: 13px">
                    If you did not create a Heaven account, you can safely
                    ignore this email.
                  </p>
                  <p style="margin: 0 0 0 0; color: #222">
                    See you inside!<br />
          ...
          <td align="center" style="padding: 24px 0">
            ...
            >
              ...
              <tr>
                <td style="padding: 24px 24px 0 24px">
                  <h2 style="margin: 0 0 12px 0; color: #222">
                    Lease Form for ${propertyName}
                  </h2>
                  <p style="margin: 0 0 16px 0; color: #444">
                    Hi ${username},<br />
                    Please fill out the lease form for ${propertyName} by
                  ...
                  <p style="margin: 0 0 12px 0; color: #888; font-size: 13px">
                    If you did not request a lease form, you can safely ignore
                    this email.
                  </p>
                  <p style="margin: 0 0 0 0; color: #222; padding-bottom: 20px">
                    Stay safe!<br />
                    <strong>The Heaven Team</strong>
                  </p>
                </td>
        ...
        <tr>
          <td align="center" style="padding: 24px 0">
            ...
            >
              ...
              <tr>
                <td style="padding: 24px 24px 0 24px">
                  <h2 style="margin: 0 0 12px 0; color: #222">Login Link</h2>
                  <p style="margin: 0 0 16px 0; color: #444">
                    Hi  ${name},<br />
                    Please use the button below to login to your haven tenants
                    account
                  </p>
                  <div style="text-align: center; margin: 24px 0">
                    <a
                  ...
                  <p style="margin: 0 0 12px 0; color: #888; font-size: 13px">
                    If you did not request a link, you can safely ignore this
                    email.
                  </p>
                  <p style="margin: 0 0 0 0; color: #222; padding-bottom: 20px">
                    Stay safe!<br />
